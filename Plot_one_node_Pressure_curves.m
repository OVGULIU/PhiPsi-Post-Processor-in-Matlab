...
if Key_One_Node_Pres==1
	...
	hold on;
    title('\it Node pressure','FontName','Times New Roman','FontSize',Size_Font)
	if ttt_DATA(1,3) ~=0
    ...
    xlabel('\it Time (months)','FontName','Times New Roman','FontSize',Size_Font) 
	% xlabel('Time step','FontName','Times New Roman','FontSize',Size_Font) 
    ylabel('\it Node pressure(MPa)','FontName','Times New Roman','FontSize',Size_Font) 	
end
